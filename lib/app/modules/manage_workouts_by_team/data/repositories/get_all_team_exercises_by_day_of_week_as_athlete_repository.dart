...
class GetAllTeamExercisesByDayOfWeekAsAthleteRepository
  ...
  GetAllTeamExercisesByDayOfWeekAsAthleteRepository(
      this._iGetAllTeamExercisesByDayOfWeekAsAthleteDataSource);
  final IGetAllTeamExercisesByDayOfWeekAsAthleteDataSource
      _iGetAllTeamExercisesByDayOfWeekAsAthleteDataSource;
  @override
  Future<ReturnData<List<ExerciseEntity>>> call(
      int teamID, String dayOfWeek) async {
    return _iGetAllTeamExercisesByDayOfWeekAsAthleteDataSource(
        teamID, dayOfWeek);
  }
}
