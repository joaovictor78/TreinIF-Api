...
routes.use('/login', permissions.allUsers, AuthenticateUserController.login);
routes.use('/register', permissions.allUsers, RegisterUserController.register);
routes.use('/refresh-token', permissions.allUsers,  RefreshTokenController.refreshToken);
routes.use('/forgot-password', permissions.allUsers, ResetPasswordUserController.forgotPassword);
routes.use('/reset-password', permissions.allUsers,  ResetPasswordUserController.resetPassword);
